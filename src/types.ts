...
export interface Rule {
  [key: string]:
    | (Object & { test: (arg: string) => boolean })
    | undefined
    | string
    | boolean
    | ((arg: any) => boolean);
...
> & {
  ...
  initialValues?: { [key: string]: StateValue };
  onSubmit: (arg: { [key: string]: StateValue }) => void;
  onError: (arg: { [key: string]: ErrorValue }) => void;
  onTouched?: (arg: { [key: string]: StateValue }) => void;
};
